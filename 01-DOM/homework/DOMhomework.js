...
var hecho = document.querySelector('#createdBy');
hecho.innerHTML = hecho.innerHTML + ' Mijail'
...
function buildToDo(todo, index) {
  ...
  // return toDoShell;
  let check = document.createElement('input'); // a
  check.type = 'checkbox';
  check.id = index; //b
  ...
  check.addEventListener('click', completeToDo) //c
